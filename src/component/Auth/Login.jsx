...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#080809", fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-b-2xl rounded-tr-2xl px-8 pt-8 pb-8"
          ...
          <div className="mb-7">
            ...
            <p className="text-xs tracking-wide" style={{ color: "#52525b" }}>Sign in to continue your streak.</p>
          </div>
          ...
          <p className="text-center text-xs" style={{ color: "#52525b" }}>
            ...
            <Link to="/signup" className="font-bold transition-colors duration-150" style={{ color: "#f97316" }}
